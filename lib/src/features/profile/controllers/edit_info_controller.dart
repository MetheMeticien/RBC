...
class EditInfoController extends GetxController {
  static EditInfoController get instance => Get.find();
  ...
  @override
  void onReady() async{
    final userInfo = await UserRepository.instance.getCurrentUserInfo();
    if(userInfo != null)
      {
        fullNameController.text = userInfo.name!;
        addressController.text = userInfo.address!;
        passwordController.text = userInfo.password!;
        selectedBloodGroup.value = userInfo.bloodGroup!;
        dateOfBirth.value = userInfo.DOB! as DateTime;
      }
